...
static const char *const STRINGS[LANG_COUNT][MSG_COUNT] = {
  [LANG_EN] = {
    ...
    [MSG_RESET_TOTAL]   = "Reset total",
    [MSG_RESET_CONFIRM] = "Press again to confirm",
  ...
  [LANG_IT] = {
    ...
    [MSG_RESET_TOTAL]   = "Azzera totale",
    [MSG_RESET_CONFIRM] = "Premi per confermare",
  ...
  [LANG_ES] = {
    ...
    [MSG_RESET_TOTAL]   = "Borrar total",
    [MSG_RESET_CONFIRM] = "Pulsa para confirmar",
  ...
  [LANG_FR] = {
    ...
    [MSG_RESET_TOTAL]   = "Effacer le total",
    [MSG_RESET_CONFIRM] = "Encore pour confirmer",
  ...
  [LANG_DE] = {
    ...
    [MSG_RESET_TOTAL]   = "Gesamt löschen",
    [MSG_RESET_CONFIRM] = "Nochmal zum Bestätigen",
  ...
  [LANG_PT] = {
    ...
    [MSG_VIBE_STRONG]   = "Forte",
    [MSG_RESET_TOTAL]   = "Zerar total",
    [MSG_RESET_CONFIRM] = "Pressione p/ confirmar",
